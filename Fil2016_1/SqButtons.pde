      ...
      switch(ID){
        ...
        case 1:    //Submenú Aymara || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Nayana sutijaxa Edwin",p2);   //Conociéndonos || 7 || Mi nombre es
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Nayaxa Punuthathwa",p5);    //Conociéndonos || 11 || Yo soy de 
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Nayaxa Pununa utjtha",p7);  //Conociéndonos || 13 || Yo vivo en
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Limaru sarasktha",p9);       //Conociéndonos || 15 || Estoy yendo a
            j=1;
          }
          //////////////////////////////////////////
          activity = 5;
        ...
        case 2:    //Submenú Aymara || Estamos viviendo
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,1,0,jaqaru_base[0],jaqaru_file[i++],false,"Jumanaka \n warurt’apxta",p2);//Estamos viviendo || 31 || Ustedes cantan
            contenidoButtons[i] = new ImageButtons(i,1,1,jaqaru_base[1],jaqaru_file[i++],false,"Jumanaka \n warurt’awapxta",p2);//Estamos viviendo || 32 || Ustedes cantaron
            contenidoButtons[i] = new ImageButtons(i,1,2,jaqaru_base[2],jaqaru_file[i++],false,"Jumanaka \n warurt’awapxata",p2);//Estamos viviendo || 33 || Ustedes cantarán
            j=1;
          }
          //////////////////////////////////////////
          activity = 10;
        ...
        case 3:    //Submenú Aymara || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Quqa (Árbol)",p1);      //Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Jawira (Río)",p2);    //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Qinaya (Nubes)",p3);    //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Jallu (Lluvia)",p4);     //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Uta (Casa)",p5);       //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Manq’a (Comida)",p6);    //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Inti/lupi/willka \n (Sol)",p7);  //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Phaxsi (Luna)",p8);    //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Warawara (Estrellas)",p9);  //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Nina \n (Fuego)",p10);     //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 31;
        ...
        case 4:    //Submenú Aymara || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Juku \n (Búho)",p1);        //Animales || Búho
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Liqiliqi \n (Liqiliqi)",p2);    //Animales || Liqiliqi 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Waq'ana \n (Pájaro bobo)",p3);     //Animales || Pájaro bobo
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Añuthaya \n (Zorrino)",p4);    //Animales || Zorrino
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Qamaqi \n (Añuje)",p5);      //Animales || Zorro 
            j=1;
          }
          //////////////////////////////////////////
          activity = 36;
        ...
        case 7:    //Submenú Jaqaru || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Shutxinhq Yolandawa",p2);     //Conociéndonos || 7 || Mi nombre es
        ...
        case 9:    //Submenú Jaqaru || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Ajtz’ munti (Árbol)",p1);  //Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Mayu (Río)",p2);         //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Urpi (Nubes)",p3);         //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Jallu (Lluvia)",p4);        //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Uta (Casa)",p5);          //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Putaka (Comida)",p6);       //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Inti (Sol)",p7);         //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Pajshi (Luna)",p8);       //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Waraja (Estrellas)",p9);       //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Nina (Fuego)",p10);        //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 70;
        ...
        case 10:   //Submenú Jaqaru || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Tuku \n (Búho)",p1);         //Animales || Búho
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Kuntiri \n (Cóndor)",p2);      //Animales || Cóndor 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Qaquchu \n (Loro)",p3);      //Animales || Loro
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Jamp'acxa \n (Sapo)",p4);    //Animales || Sapo
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Cxuqaya \n (Zorzal)",p5);      //Animales || Zorzal
            j=1;
          }
          //////////////////////////////////////////
          activity = 75;
        ...
        case 14:   //Submenú Quechua || Estamos viviendo
          ...
          if(j==0){
            ...
            p1.setMediaFile("vacio.mp3");   p1.setLooping(false);   p1.setVolume(1.0, 1.0);
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,1,0,jaqaru_base[0],jaqaru_file[i++],false,"Ñuqam takichkani \n /takini",p1); //Estamos viviendo || 16 || Yo canto 
        ...
        case 15:   //Submenú Quechua || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Mallki (Árbol)",p1);   //Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Mayu \n (Río)",p2);     //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Phuyu \n  (Nubes)",p3);    //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Para \n (Lluvia)",p4);     //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Wasi \n (Casa)",p5);     //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Mikhuna  \n (Comida)",p6);  //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Inti \n (Sol)",p7);     //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Killa (Luna)",p8);    //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Ch’aska (Estrellas)",p9);  //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Nina \n (Fuego)",p10);    //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
        ...
        case 16:   //Submenú Quechua || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Huku \n (Búho)",p1);         //Animales || Búho
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"K'illichu \n (Cérnicalo)",p2);    //Animales || Cernícalo 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Kuntur \n (Cóndor)",p3);        //Animales || Cóndor
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Chiwaqu \n (Tordo)",p4);      //Animales || Tordo
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Añas \n (Zorrino)",p5);         //Animales || Zorrino
            j=1;
          }
          //////////////////////////////////////////
          activity = 114;
        ...
        case 21:   //Submenú Shipibo || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Jiwi niibo (Árbol)",p1);//Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Paro (Río)",p2);      //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Nai koin (Nubes)",p3);  //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Oi (Lluvia)",p4);        //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Xobo (Casa)",p5);      //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Piti (Comida)",p6);      //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Bari (Sol)",p7);      //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Oxe (Luna)",p8);       //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Wishtinbo (Estrellas)",p9); //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Chií tiri \n (Fuego)",p10); //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 148;
        ...
        case 22:   //Submenú Shipibo || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Misho \n (Gato)",p1);      //Animales || Gato
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Nonon \n (Pato)",p2);      //Animales || Pato 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Pitso \n (Perico)",p3);      //Animales || Perico
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Ochiti \n (Perro)",p4);     //Animales || Perro
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Shipi \n (Pichico)",p5);      //Animales || Pichico
            j=1;
          }
          //////////////////////////////////////////
          activity = 153;
        ...
        case 24:   //Submenú Matsiguenka || Saludándonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Je’je \n eje aiñona",p2);  //Saludandonos || 1 || Hola || Respuesta
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"Atana \n oatavaeta",p3);   //Saludandonos || 2 || Chau || Despedida
        ...
        case 25:   //Submenú Matsiguenka || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Akati \n pishiriagakotanaka?",p3);              //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Naro noshiriagakotanaka \n 43 shiriagarini",p4);//Conociéndonos || 9 || Yo tengo
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Naro notimi \n monte carmelo",p8);                         //Conociéndonos || 13 || Yo vivo en
        ...
        case 26:   //Submenú Matsiguenka || Estamos viviendo
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,1,2,jaqaru_base[2],jaqaru_file[i++],false,"Irorori \n omatikakerookari",p12);    //Estamos viviendo || 27 || Ella cantará
            contenidoButtons[i] = new ImageButtons(i,1,0,jaqaru_base[0],jaqaru_file[i++],false,"Naroegi \n nomatikaigake",p13);       //Estamos viviendo || 28 || Nosotros cantamos
            contenidoButtons[i] = new ImageButtons(i,1,1,jaqaru_base[1],jaqaru_file[i++],false,"Naroegi \n nomatikaigakiti",p14);     //Estamos viviendo || 29 || Nosotros cantamos
            contenidoButtons[i] = new ImageButtons(i,1,2,jaqaru_base[2],jaqaru_file[i++],false,"Naroegi \n nomatikaigakerookari",p15);//Estamos viviendo || 30 || Nosotros cantaremos
            contenidoButtons[i] = new ImageButtons(i,1,0,jaqaru_base[0],jaqaru_file[i++],false,"Viroegi \n pimatikaigake",p16);       //Estamos viviendo || 31 || Ustedes cantan
            contenidoButtons[i] = new ImageButtons(i,1,1,jaqaru_base[1],jaqaru_file[i++],false,"Viroegi \n pimatikaigakiti",p17);     //Estamos viviendo || 32 || Ustedes cantaron
            contenidoButtons[i] = new ImageButtons(i,1,2,jaqaru_base[2],jaqaru_file[i++],false,"Viroegi \n pimatikaigakerookari",p18);//Estamos viviendo || 33 || Ustedes cantarán
            j=1;
          }
          //////////////////////////////////////////
          activity = 166;
        ...
        case 27:   //Submenú Matsiguenka || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Inchato/inkenishi (Árbol)",p1);    //Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Eni \n (Río)",p2);                  //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Menkori (Nubes)",p3);              //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Inkani (Lluvia)",p4);               //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Pankotsi (Casa)",p5);             //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Sekatsi (Comida)",p6);              //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Poreatsiri (Sol)",p7);           //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Kashiri (Luna)",p8);              //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Impokiro/impokiropage (Estrellas)",p9);//Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Morekari \n (Fuego)",p10);             //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 187;
        ...
        case 28:   //Submenú Matsiguenka || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Tontokoti \n (Búho)",p1);      //Animales || Búho
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"",p2);               //Animales || Vacio 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Maeni \n (Oso)",p3);          //Animales || Oso
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"",p4);               //Animales || Vacio
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Matsontsori \n (Tigre)",p5);    //Animales || Tigre
            j=1;
          }
          //////////////////////////////////////////
          activity = 192;
        ...
        case 31:   //Submenú Yine || Conociéndonos
          ...
          if(j==0){
            ...
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Ngiwakni José",p2);             //Conociéndonos || 7 || Mi nombre es
            contenidoButtons[i] = new ImageButtons(i,0,0,jaqaru_base[0],jaqaru_file[i++],true,"¿Gipejnu walapu\nwanenyi?",p3); //Conociéndonos || 8 || ¿Cuántos años tienes?
            contenidoButtons[i] = new ImageButtons(i,0,1,jaqaru_base[1],jaqaru_file[i++],true,"Pamyomole walapu\nwanenyno",p4);//Conociéndonos || 9 || Yo tengo
        ...
        case 33:   //Submenú Yine || Madre tierra
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Kashegiru (Árbol)",p1); //Madre tierra || 34 || Árbol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Tsruru \n (Río)",p2);    //Madre tierra || 35 || Río 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Kamkolu (Nubes)",p3);   //Madre tierra || 34 || Nubes
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Gina \n(Lluvia)",p4);      //Madre tierra || 35 || Lluvia
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Panchi \n (Casa)",p5);    //Madre tierra || 34 || Casa
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[5],jaqaru_base[i++],false,"Niikaluru \n (Comida)",p6); //Madre tierra || 35 || Comida
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[6],jaqaru_base[i++],false,"Tkachi \n (Sol)",p7);    //Madre tierra || 34 || Sol
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[7],jaqaru_base[i++],false,"Ksuru \n (Luna)",p8);     //Madre tierra || 35 || Luna 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[8],jaqaru_base[i++],false,"Katagiri (Estrellas)",p9);  //Madre tierra || 34 || Estrellas
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[9],jaqaru_base[i++],false,"Katalu \n (Fuego)",p10);    //Madre tierra || 35 || Fuego 
            j=1;
          }
          //////////////////////////////////////////
          activity = 226;
        ...
        case 34:   //Submenú Yine || Animales
          ...
          if(j==0){
            ...
            int i=0;
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[0],jaqaru_base[i++],false,"Pejru \n (Añuje)",p1);      //Animales || Añuje
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[1],jaqaru_base[i++],false,"Chikga \n (Chicua)",p2);     //Animales || Chicua 
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[2],jaqaru_base[i++],false,"Giyeka \n (Paujil)",p3);     //Animales || Paujil
            contenidoButtons[i] = new ImageButtons(i,2,1,jaqaru_base[3],jaqaru_base[i++],false,"Mgenoklu \n (Tigre)",p4);   //Animales || Tigre
            contenidoButtons[i] = new ImageButtons(i,2,0,jaqaru_base[4],jaqaru_base[i++],false,"Gogru \n (Unchala)",p5);      //Animales || Unchala
            j=1;
          }
          //////////////////////////////////////////
          activity = 231;
